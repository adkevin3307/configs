...
function install_packages()
{
    ...
    case $OS in
        ubuntu)
            execute 'apt install -y zsh gcc git lazygit bat fzf htop tmux tree wget curl direnv diffutils unzip fd-find ripgrep python3-pip python3-venv gnupg ca-certificates cargo'
            ...
            ;;
        arch)
            execute 'pacman -S zsh gcc git lazygit bat fzf btop tmux tree wget curl direnv diffutils unzip fd ripgrep python-pip python-virtualenv nodejs npm rust --noconfirm'
